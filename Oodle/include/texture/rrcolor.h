...
// @@ TODO : REMOVE ME
//	math.h not used here, but lots of other users in Tex are getting it from me
#include <math.h>
...
// pack a 565 color stored in bytes (NOT Quantize)
static RADFORCEINLINE rrColor565Bits rrColor565Bits_Pack(const rrColor32BGRA & color565)
{
	RR_ASSERT( color565.u.r < 32 );
	RR_ASSERT( color565.u.g < 64 );
	RR_ASSERT( color565.u.b < 32 );
	rrColor565Bits ret;
	ret.u.b = color565.u.b;
	ret.u.g = color565.u.g;
	ret.u.r = color565.u.r;
	return ret;
}

static RADFORCEINLINE rrColor32BGRA rrColor565Bits_UnPack(rrColor565Bits c)
{
	rrColor32BGRA ret;
	ret.u.b = c.u.b;
	ret.u.g = c.u.g;
...
// color is 565, just scored in bytes
static RADFORCEINLINE rrColor32BGRA rrColor32BGRA_565_UnQuantize(const rrColor32BGRA & color565)
{
	RR_ASSERT( color565.u.r < 32 );
	RR_ASSERT( color565.u.g < 64 );
	RR_ASSERT( color565.u.b < 32 );
	rrColor32BGRA ret;
	ret.u.b = (color565.u.b * 33) >> 2;
	ret.u.g = (color565.u.g * 65) >> 4;
	ret.u.r = (color565.u.r * 33) >> 2;
	ret.u.a = 255;
	return ret;
}
